...
public class My_requests_Activity extends AppCompatActivity {
    ListView listView;
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity activity = My_requests_Activity.this;

        MyListAdapter_MyRequests adapter = new MyListAdapter_MyRequests(this, R.layout.list_item_request, ridesList, rides, ApplicationContext, activity);
        ...
        referenceRide.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                for (DataSnapshot snapshot : datasnapshot.getChildren()) {
                    ...
                    Map<String, User> waiting_list=ride.getWaiting_list();
                    if(waiting_list!=null) {
                        if(waiting_list.keySet().contains(mAuth.getCurrentUser().getUid()))
                        {
